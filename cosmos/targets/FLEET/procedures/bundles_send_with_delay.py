# Send bundles to DTN Node during long duration or subsystem test with a 2-second delay between bundles
#
# Example usage: bundles_send(103, 1, 1000, 5, 2, "10.2.14.233", 4558, 1)
#

def bundles_send_with_delay(dest_number= None, dest_service= None, payload_size = None, lifetime_in_sec = None, total_send_loops = None, send_to_ip = None, send_to_port = None, rate_limit = None):
