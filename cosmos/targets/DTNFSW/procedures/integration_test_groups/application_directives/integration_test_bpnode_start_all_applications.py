...
class integration_test_bpnode_start_all_applications(Group):
    """
    Test cases for the BPNode "start_all_applications" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_start_all_applications(self):
        """
        Nominal test
        """
