...
class integration_test_bpnode_clean_storage(Group):
    """
    Test cases for the BPNode "clean_storage" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_clean_storage(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_CLEAN_STORAGE")
