...
class integration_test_bpnode_reset_bundle_counters(Group):
    """
    Test cases for the BPNode "reset_bundle_counters" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_reset_bundle_counters(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_RESET_BUNDLE_COUNTERS")
