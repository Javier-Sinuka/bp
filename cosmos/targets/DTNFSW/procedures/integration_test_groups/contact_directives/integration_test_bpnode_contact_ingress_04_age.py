...
class integration_test_bpnode_contact_ingress_04(Group):
    """
    Test Group
    """

    def test_bpnode_bundle_ingress_04(self):
        """
        Nominal test
        """
        ...
        try:
            ...
            # TODO: Update to generate hop count (instead of prev node)
            ...
            # Check the age block
            check_expression(f"{received_bundle.canon_blocks[0].blk_type} == {BlockType.BUNDLE_AGE}")
            ...
            check_expression(f"{received_bundle.canon_blocks[0].bundle_age} >= {deserialized_input_bundle.canon_blocks[0].bundle_age}")
