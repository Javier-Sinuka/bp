...
class integration_test_bpnode_contact_ingress_05(Group):
    """
    Test Group
    """

    def test_bpnode_bundle_ingress_05(self):
        """
        Nominal test
        """
        ...
        try:
            ...
            check_expression(f"{received_bundle.canon_blocks[0].crc_type} == {CRCType.NONE}")
            ...
            check_expression(f"{received_bundle.canon_blocks[1].crc_type} == {CRCType.NONE}")
            ...
            check_expression(f"{received_bundle.canon_blocks[2].crc_type} == {CRCType.NONE}")
            ...
            check_expression(f"{received_bundle.canon_blocks[3].crc_type} == {CRCType.NONE}")
