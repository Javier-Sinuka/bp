...
#define BPNODE_NODE_MIB_REPORTS_HK_TLM_MID      CFE_PLATFORM_TLM_TOPICID_TO_MIDV(CFE_MISSION_BPNODE_NODE_MIB_REPORTS_HK_TLM_TOPICID)
...
#define BPNODE_CLA_IN_BUNDLE_MID                CFE_PLATFORM_CMD_TOPICID_TO_MIDV(CFE_MISSION_BPNODE_CLA_IN_BUNDLE_CMD_TOPICID)
#define BPNODE_CLA_OUT_BUNDLE_MID               CFE_PLATFORM_TLM_TOPICID_TO_MIDV(CFE_MISSION_BPNODE_CLA_OUT_BUNDLE_TLM_TOPICID)
