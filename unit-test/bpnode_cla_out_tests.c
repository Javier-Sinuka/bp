...
void Test_BPNode_ClaOutCreateTasks_TaskCrErr(void)
{
    ...
    UtAssert_STRINGBUF_EQ("Failed to create child task for CLA Out #%d. Error = 0x%08X.", BPLIB_EM_EXPANDED_EVENT_SIZE,
...
void Test_BPNode_ClaOut_TaskMain_NoBundleAvailable(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.EgressBitsPerCycle = 100000;
...
void Test_BPNode_ClaOut_TaskMain_MaxBundles(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.EgressBitsPerCycle = RateLimit * 8;
...
void Test_BPNode_ClaOut_TaskMain_FailedProcBundle(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.EgressBitsPerCycle    = 1000;
...
void Test_BPNode_ClaOut_TaskMain_RateLimitedOver(void)
{
    ...
    UtAssert_EQ(size_t,
                ...
                OrigBitsEgressed - BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.EgressBitsPerCycle);
...
void Test_BPNode_ClaOut_ProcessBundleOutput_UdpNom(void)
{
    ...
    ContactId = 0;
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.CLAType = BPLib_UDP_CLA;
...
void Test_BPNode_ClaOut_ProcessBundleOutput_LtpNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.CLAType = BPLib_LTP_CLA;
...
void Test_BPNode_ClaOut_ProcessBundleOutput_EppNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.CLAType = BPLib_EPP_CLA;
...
void Test_BPNode_ClaOut_ProcessBundleOutput_TcpNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.CLAType = BPLib_TCP_CLA;
...
void Test_BPNode_ClaOut_ProcessBundleOutput_Default(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContactId].Config.CLAType = 0xff;
...
void Test_BPNode_ClaOut_Setup_UdpNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContId].Config.CLAType = BPLib_UDP_CLA;
...
void Test_BPNode_ClaOut_Setup_SbNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContId].Config.CLAType = BPLib_SB_CLA;
...
void Test_BPNode_ClaOut_Setup_LtpNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContId].Config.CLAType = BPLib_LTP_CLA;
...
void Test_BPNode_ClaOut_Setup_EppNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContId].Config.CLAType = BPLib_EPP_CLA;
...
void Test_BPNode_ClaOut_Setup_TcpNom(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContId].Config.CLAType = BPLib_TCP_CLA;
...
void Test_BPNode_ClaOut_Setup_Default(void)
{
    ...
    BPNode_AppData.BplibInst.ContCtxt[ContId].Config.CLAType = 0xff;
