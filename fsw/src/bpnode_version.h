...
#define BPNODE_BUILD_NUMBER    (2u) /*!< Development Build: Number of development builds (not commits) since baseline */
...
#define BPNODE_REVISION      4  /*!< @brief Revision version number. Value of 0 indicates a development version.*/
