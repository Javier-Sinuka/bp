...
TO_LAB_Subs_t TO_LAB_Subs = {.Subs = {/* CFS App Subscriptions */
                                      ...
                                      {CFE_SB_MSGID_WRAP_VALUE(BPNODE_ADU_OUT_SEND_TO_MID), {0, 0}, 10},
                                      {CFE_SB_MSGID_WRAP_VALUE(BPNODE_CLA_OUT_BUNDLE_MID), {0, 0}, 32},

#ifdef HAVE_BPACC_FUN
                                      /* BPACC_FUN TLM */
                                      {CFE_SB_MSGID_WRAP_VALUE(BPACC_FUN_HK_TLM_MID), {0, 0}, 4},
#endif
