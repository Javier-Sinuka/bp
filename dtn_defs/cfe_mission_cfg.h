...
*/
#define CFE_MISSION_MAX_PATH_LEN 128
...
**       any possible neighboring fields without implicit padding.
*/
#define CFE_MISSION_MAX_FILE_LEN 64
...
**      DTN Note: These values are now also used by BPNode's Time Proxy to correlate the
**                DTN epoch to the cFS epoch and have been updated to match the ground 
**                system's epoch (Unix epoch).
**
**  \par Limits
...
**      Micros - 0 to 999999
*/
#define CFE_MISSION_TIME_EPOCH_YEAR   1970
