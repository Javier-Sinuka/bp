...
BPLib_PI_ChannelTable_t ChannelTable = {
    .Configs = {
        /* Channel 0 */
        {
            ...
            .HopLimit               = 10,
            .LocalServiceNumber     = BPNODE_EID_SERVICE_NUM_FOR_CONTACT_0,
            .IngressBitsPerCycle    = 4000000,  /* Ingress rate, 4Mb per cycle */
            .EgressBitsPerCycle     = 4000000,  /* Egress rate, 4Mb per cycle */
